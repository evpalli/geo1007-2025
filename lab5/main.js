...
let options = {
  maxZoom: 14,
  attribution:
    'Map data: <a href="http://www.pdok.nl">BRT Achtergrondkaart</a>',
};
let basemap_pdok = new L.tileLayer(
...
function registerGeoLocate(mapInstance) {
  ...
  function onLocationFound(e) {
    ...
    let m = L.marker(e.latlng)
      .addTo(map)
      .bindPopup(
        "You are within " + radius.toFixed(1) + " meters from this point",
      )
      .openPopup();
